  ...
  <div class="pt-32 pb-20 min-h-screen">
    <div class="max-w-4xl mx-auto px-6">
      <section class="mb-16 text-center">
        ...
        >
          Case studies and deep dives into High-Velocity architectures and
      ...
      <div class="space-y-16">
        ...
        >
          ...
          <h2 class="text-3xl font-bold text-slate-700 dark:text-white mb-6">
            {{ study.title }}
          </h2>
          ...
          <div class="prose prose-slate dark:prose-invert max-w-none">
            ...
            <div class="grid md:grid-cols-2 gap-8 mt-8">
              <div>
                ...
                >
                  <Icon
                    :icon="study.solutionIcon"
                    :class="study.solutionIconClass"
                  />
                  {{ study.solutionTitle }}
                </h3>
              ...
              <div>
                ...
                >
                  <Icon
                    :icon="study.impactIcon"
                    :class="study.impactIconClass"
                  />
                  {{ study.impactTitle }}
                </h3>
                <p class="text-slate-600 dark:text-gray-400">
...
const caseStudies = [
  ...
  },
  {
    ...
    title: "Saadhaka ILS",
    description: "A hybrid chemistry engine designed to bridge the gap between static textbook knowledge and dynamic synthesis simulations. It maps the organic chemistry syllabus into a navigable Knowledge Graph.",
    solutionIcon: "ph:flask-duotone",
    solutionIconClass: "text-primary",
    solutionTitle: "Hybrid AI Engine",
    solutionDescription: "Built a dual-layer system combining a hard-coded Knowledge Graph for syllabus accuracy with an AI/RAG layer for real-time reactivity predictions and molecular insights.",
    impactIcon: "ph:brain-duotone",
    impactIconClass: "text-secondary",
    impactTitle: "Interactive Discovery",
    impactDescription: "Enabled automated generation of complex conversion challenges and a 'Lab Playground' where students discover synthesis routes through guided experimentation."
  }
,
];
</script>
